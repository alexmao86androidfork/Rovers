...
//        mValueText.setTextSize(32);
        ...
        layout.addView(customLayout, params);

        mValueText = (TextView)layout.findViewById(android.R.id.text1);
    ...
    protected View getCustomLayout(){
        return LayoutInflater.from(mContext)
                .inflate(R.layout.layout_pref_seekbar, null, false);
    }
    ...
    protected CharSequence getEntryFromValue(int value) {
        CharSequence[] entries = getEntries();
        return value >= 0 && entries != null ? entries[value] : null;
    }

    protected CharSequence getValueFromValue(int value){
        CharSequence[] values = getEntryValues();
        return value >= 0 && values != null ? values[value] : null;
    }
