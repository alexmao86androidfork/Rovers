package com.schiztech.rovers.app.ui.reveallayout;
...
//            Log.d("RevealLayout", "ClipRadius: " + mClipRadius);
    ...
    //region OnRevealEnded Listener

    OnRevealEndedListener mRevealEndedListener;

    public interface OnRevealEndedListener{
        void onRevealEnded();
    }

    public void setOnRevealEndedListener(OnRevealEndedListener listener){
        mRevealEndedListener = listener;
    }

    private void callRevealEndedListener(){
        if(mRevealEndedListener != null)
            mRevealEndedListener.onRevealEnded();
    }
