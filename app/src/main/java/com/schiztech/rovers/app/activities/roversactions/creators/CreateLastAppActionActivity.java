...
public class CreateLastAppActionActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent.ShortcutIconResource iconResource =
                Intent.ShortcutIconResource.fromContext(this, R.drawable.ic_roveraction_lastapp);


        Intent launchIntent = new Intent(this, LastAppActionActivity.class);

        Intent result = RoversActionBuilder.build()
                .setColor(getResources().getColor(R.color.md_purple_A400))
                .setIconResource(iconResource)
                .setLabel(getResources().getString(R.string.roveraction_lastapp_label))
