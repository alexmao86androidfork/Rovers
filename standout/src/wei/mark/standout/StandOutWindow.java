...
public abstract class StandOutWindow extends Service {
    ...
    /**
     * Called right after the window is closed.
     *
     * @param id The id of the view, provided as a courtesy.
     */
    ...
    /**
     * Called right after the window is hidden.
     *
     * @param id The id of the view, provided as a courtesy.
     */
    ...
    public final synchronized Window show(final int id) {
        ...
        if (window.visibility == Window.VISIBILITY_VISIBLE) {
            Log.w("StandOutWindow","Tried to show(" + id
        ...
        try {
            ...
            // animate
            if (animation != null) {
                //notify that the window is shown when animation finished
                animation.setAnimationListener(new AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        onWindowShown(id);//notify that the window is shown when animation finished
                    }
     ...
     * @param id The id of the window.
     */
    public final synchronized void hide(final int id) {
...
//                    + ") a window that is not shown.");
            Log.w(TAG, "Tried to hide(" + id + ") a window that is not shown.");
            return;
        }
        ...
        if (Utils.isSet(window.flags, StandOutFlags.FLAG_WINDOW_HIDE_ENABLE)) {
            ...
            mNotificationManager.notify(getClass().hashCode() + ONGOING_NOTIFICATION_ID,
                    notification);
    ...
    public final synchronized boolean focus(int id) {
        ...
        final Window window = getWindow(id);
        if (window == null) {
            Log.e("StandOutWindow", "Tried to focus(" + id
                    + ") a null window.");
            return false;
        }
